...
Lettuce: {
	...
	config: [
		...
		// Lettuce -> HTTP ingress to your container
		#domain & {
		...
		#route & {
			...
			redirects: [
				{
					from:          "^/services/grocerylist/lettuce$"
					to:            route_match.path
		...
		// Grey Matter catalog service definition for lettuce
		#catalog_entry & {
			name:                      Name
		...
		// Shared lettuce proxy object. All configs
